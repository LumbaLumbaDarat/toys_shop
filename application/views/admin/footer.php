    ...
    <script>
      $(document).ready(function () {
        ...
        $('#datatable-admin-modified-2').DataTable({
            dom: "Blfrtip",
                buttons: [
                    {
                        extend: "copy",
        ...
        $('#datatable-admin-modified-3').DataTable({
            dom: "Blfrtip",
                buttons: [
                    {
                        extend: "copy",
        ...
        $('#datatable-admin-report-2').DataTable({
            dom: "Blfrtip",
                buttons: [
                    {
                        extend: "copy",
    ...
    <!-- Chart.js -->
    <script src="<?php echo base_url('assets/admin_template/vendors/Chart.js/dist/Chart.min.js') ?>"></script>
    <!-- gauge.js -->
    <script src="<?php echo base_url('assets/admin_template/vendors/gauge.js/dist/gauge.min.js') ?>"></script>
    <!-- bootstrap-progressbar -->
    <script src="<?php echo base_url('assets/admin_template/vendors/bootstrap-progressbar/bootstrap-progressbar.min.js') ?>"></script>
    <!-- iCheck -->
    <script src="<?php echo base_url('assets/admin_template/vendors/iCheck/icheck.min.js') ?>"></script>
    <!-- Skycons -->
    <script src="<?php echo base_url('assets/admin_template/vendors/skycons/skycons.js') ?>"></script>
    <!-- Flot -->
    <script src="<?php echo base_url('assets/admin_template/vendors/Flot/jquery.flot.js') ?>"></script>
    <script src="<?php echo base_url('assets/admin_template/vendors/Flot/jquery.flot.pie.js') ?>"></script>
    <script src="<?php echo base_url('assets/admin_template/vendors/Flot/jquery.flot.time.js') ?>"></script>
    <script src="<?php echo base_url('assets/admin_template/vendors/Flot/jquery.flot.stack.js') ?>"></script>
    <script src="<?php echo base_url('assets/admin_template/vendors/Flot/jquery.flot.resize.js') ?>"></script>
    <!-- Flot plugins -->
    <script src="<?php echo base_url('assets/admin_template/vendors/flot.orderbars/js/jquery.flot.orderBars.js') ?>"></script>
    <script src="<?php echo base_url('assets/admin_template/vendors/flot-spline/js/jquery.flot.spline.min.js') ?>"></script>
    <script src="<?php echo base_url('assets/admin_template/vendors/flot.curvedlines/curvedLines.js') ?>"></script>
    <!-- DateJS -->
    <script src="<?php echo base_url('assets/admin_template/vendors/DateJS/build/date.js') ?>"></script>
    <!-- JQVMap -->
    <script src="<?php echo base_url('assets/admin_template/vendors/jqvmap/dist/jquery.vmap.js') ?>"></script>
    <script src="<?php echo base_url('assets/admin_template/vendors/jqvmap/dist/maps/jquery.vmap.world.js') ?>"></script>
    <script src="<?php echo base_url('assets/admin_template/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js') ?>"></script>
